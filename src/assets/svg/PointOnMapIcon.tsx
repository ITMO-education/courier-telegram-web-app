export function PointOnMapIcon() {
    return (
        <svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg">
            ...
            <path d="M21 21L3 11" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round"/>
            <path d="M3.5 21L12 16" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round"/>
            <circle cx="17" cy="5" r="3" stroke="#1C274C" strokeWidth="1.5"/>
            <path d="M17 13L17 8" stroke="#1C274C" strokeWidth="1.5" strokeLinecap="round"/>
        </svg>
    )
}
